...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (company-tabnine ggtags multi-vterm evil-smartparens zenburn-theme zeal-at-point yasnippet-snippets yaml-mode xterm-color writeroom-mode winum which-key vterm volatile-highlights vi-tilde-fringe uuidgen use-package twilight-bright-theme treemacs-projectile treemacs-persp treemacs-magit treemacs-icons-dired treemacs-evil toc-org terminal-here symon symbol-overlay string-inflection spaceline-all-the-icons solarized-theme smeargle shell-pop restart-emacs rainbow-delimiters protobuf-mode professional-theme popwin plantuml-mode pcre2el password-generator paradox org-bullets open-junk-file multi-term move-text monokai-theme mmm-mode markdown-toc magit-svn magit-section magit-gitflow lsp-ui lsp-treemacs lorem-ipsum log4j-mode link-hint indent-guide hybrid-mode hungry-delete hl-todo highlight-parentheses highlight-numbers highlight-indentation helm-xref helm-themes helm-swoop helm-rtags helm-purpose helm-projectile helm-mode-manager helm-make helm-lsp helm-ls-git helm-gitignore helm-git-grep helm-flx helm-descbinds helm-dash helm-company helm-c-yasnippet helm-ag groovy-mode google-translate google-c-style golden-ratio gitignore-templates gitconfig-mode gitattributes-mode git-timemachine git-messenger git-link git-gutter-fringe+ gh-md fuzzy font-lock+ fold-dwim flycheck-ycmd flycheck-rtags flycheck-pos-tip flx-ido fill-column-indicator fancy-battery eyebrowse expand-region evil-visualstar evil-visual-mark-mode evil-unimpaired evil-tutor evil-textobj-line evil-surround evil-numbers evil-nerd-commenter evil-matchit evil-magit evil-lisp-state evil-lion evil-indent-plus evil-iedit-state evil-goggles evil-exchange evil-escape evil-ediff evil-cleverparens evil-args evil-anzu eval-sexp-fu eshell-z eshell-prompt-extras esh-help editorconfig dumb-jump dotenv-mode disaster diminish devdocs define-word cpp-auto-include company-ycmd company-rtags company-lsp company-c-headers column-enforce-mode cmake-ide clean-aindent-mode clang-format centered-cursor-mode ccls browse-at-remote auto-yasnippet auto-highlight-symbol anaconda-mode aggressive-indent ag ace-link ace-jump-helm-line ac-ispell))))
(custom-set-faces
